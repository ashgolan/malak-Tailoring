...
const COLS = [
  ...
  { key: "number",      label: "סכום",          type: "number",  width: "9%"  },
    ...
    <div style={{ display:"flex", flexDirection:"column", gap:20, direction:"rtl" }}>
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", flexWrap:"wrap", gap:12 }}>
        <div style={{ display:"flex", alignItems:"center", gap:12 }}>
          ...
          <div>
            <h1 style={{ fontSize:22, fontWeight:700, color:"#1f2937", margin:0 }}>הוצאות</h1>
                ...
                {COLS.map(col => (
                  <div key={col.key} style={{ ...CELL(col.width), color: item.colored ? "#991b1b" : "#374151" }}>
                    {isEditing ? (
                      ...
                      col.type==="boolean"
                        ? (item[col.key] ? <span style={{ color:"#16a34a", fontWeight:600, fontSize:11 }}>✓ מע״מ</span> : <span style={{ color:"#9ca3af", fontSize:11 }}>ללא</span>)
