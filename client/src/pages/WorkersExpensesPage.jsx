          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            ...
            <div>
              ...
              <AutocompleteInput value={val("location")} onChange={e => set("location", e.target.value)}
                suggestions={allLocations} style={S.input} onFocus={e => fo(e, theme.accent)} onBlur={bl} />
            </div>
            <div>
              <label style={S.label}>עבודה</label>
              <AutocompleteInput value={val("equipment")} onChange={e => set("equipment", e.target.value)}
                suggestions={allEquipment} style={S.input} onFocus={e => fo(e, theme.accent)} onBlur={bl} />
            </div>
            <div>
