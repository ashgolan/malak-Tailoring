  ...
  return (
    <div style={{ background: "#fff", border: "1px solid #e8e8e8", borderRadius: 14, overflow: "hidden" }}>
      ...
      <div onClick={() => setOpen(o => !o)}
        style={{
          display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 18px", cursor: "pointer", userSelect: "none",
      ...
      <div style={{ maxWidth: 720, display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <SectionCard title="גיבוי נתונים" icon="💾" gradient="linear-gradient(135deg, #059669, #047857)">
          ...
          <button onClick={async () => {
            ...
            try {
              await settingsApi.sendBackup();
              toast.success("הגיבוי נשלח למייל ✓");
            } catch {
              toast.error("שגיאה בשליחת הגיבוי");
            } finally {
              setSendingBackup(false);
            }
          }} disabled={sendingBackup} style={btnStyle("#0284c7")}>
            {sendingBackup ? (
              <>
